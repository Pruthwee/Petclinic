...
public class PetclinicInitializer extends AbstractDispatcherServletInitializer {
    ...
    @Override
    @Override
    protected SpringApplicationContext[] getRootApplicationContexts() {
    }

    @Override
    protected SpringApplicationContext[] getServletApplicationContexts() {
        return new SpringApplicationContext[]{ new AnnotationConfigWebApplicationContext() {{ register(MvcCoreConfig.class); }} };
    }
    @Override
    protected SpringApplicationContext[] getServletApplicationContexts() {
